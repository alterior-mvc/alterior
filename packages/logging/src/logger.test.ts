...
const SAMPLE_LOG_MESSAGE_1 : LogEvent = { type: 'message', message: 'ABCDEF', date: new Date(), severity: 'info', context: null, contextLabel: undefined, sourceLabel: undefined };
const SAMPLE_LOG_MESSAGE_2 : LogEvent = { type: 'message', message: '123456', date: new Date(), severity: 'info', context: null, contextLabel: undefined, sourceLabel: undefined };
const SAMPLE_LOG_MESSAGE_3 : LogEvent = { type: 'message', message: 'TUVXYZ', date: new Date(), severity: 'info', context: null, contextLabel: undefined, sourceLabel: undefined };
